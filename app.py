        ...
        resp = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": (
                    ...
                    "Prescribe drugs and provide guidance for fast recovery in short and clear. Always include reliable medical references for each doctor. Minimum 5 doctors. Each doctor suggestion must be suppareted with box"
                )},
