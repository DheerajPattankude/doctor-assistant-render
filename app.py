...
def call_hf_chat(prompt: str, model: str = "meta-llama/Llama-3.1-8B-Instruct:cerebras") -> str:
    ...
    try:
        ...
        resp = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": (
                    "You are a medical assistant AI. Use doctor-verified sites to answer use indian and foreign doctors. "
    ...
    with left:
        ...
        for idx, block in enumerate(advice_blocks):
            ...
            <div style="border:2px solid #38a169;border-radius:10px;margin:10px 0;overflow:hidden;">
                ...
                <div style="background:#FF9933;padding:15px;">
                    {translated_content}
                </div>
            </div>
            """
        ...
        for rf in RED_FLAGS:
            st.markdown(
                f'<div style="background:FF0000;border-left:5px solid #dd6b20;'
